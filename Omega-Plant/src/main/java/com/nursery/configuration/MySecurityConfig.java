...
public class MySecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf()
			...
			.antMatchers("/admin/add/seeds").permitAll()
			.antMatchers("/admin/update/seeds").permitAll()
			.antMatchers("/admin/delete/seeds").permitAll()
			.antMatchers("/admin/add/plants").permitAll()
			.antMatchers("/admin/update/plants").permitAll()
			.antMatchers("/admin/delete/plants").permitAll()
			.antMatchers("/admin/add/planter").permitAll()
			.antMatchers("/admin/user/getAllPlant").permitAll()
			.antMatchers("/admin/user/getAllSeed").permitAll()
			.antMatchers("/admin/user/getAllPlanter").permitAll()
